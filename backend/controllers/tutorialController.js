...
exports.createTutorial = asyncHandler(async (req, res, next) => {
  ...
  return res.status(200).json({ success: true, message: 'Tutorial created' });
});
...
// Cannot update all tutorial at once
...
// Cannot update all tutorial subtopics at once
// function updateTutorialSubTopics() {}
...
// Cannot delete all Tutorials at once
...
// Cannot delete all Topics at once
// function deleteTutorialTopics() {}
...
// Cannot delete all SubTopics at once
// function deleteTutorialSubTopics() {}
